...
def scrape_data(url, key):
    ...
    team_stats[key]['team1'] = stat_data.get(team1)  # assigns the corresponding stat name (key) as a key, and as its value assigns
#                                                      a subdictionary, with 'teamx' as the key and the stat value as its value
